...
if __name__ == '__main__':
    ...
    model.load('C:/Users/sim/Lab/심영준_포항공대/미세먼지/training/finedust__forecast_multivar_20230822_160946/model.pkl')    
    ...
    if args.eval:
        ...
        elif task_type == 'finedust_forecasting':
            out, eval_res = tasks.eval_finedust_forecasting(model, data, train_slice, valid_slice, test_slice, scaler, pred_lens, n_covariate_cols)
        else:
            assert False
